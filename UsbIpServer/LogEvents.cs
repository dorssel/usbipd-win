...
namespace UsbIpServer
{
    ...
    {
        [LoggerMessage(EventId = 1, Level = LogLevel.Information, Message = "Client {clientAddress} claimed device at {busId} ({devicePath}).")]
        public static partial void ClientAttach(this ILogger logger, IPAddress clientAddress, BusId busId, string devicePath);

        [LoggerMessage(EventId = 2, Level = LogLevel.Information, Message = "Client {clientAddress} released device at {busId} ({devicePath}).")]
        public static partial void ClientDetach(this ILogger logger, IPAddress clientAddress, BusId busId, string devicePath);
